...
export function AddPictureIcon(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M5.5 5.891a1.645 1.645 0 10.005 3.293A1.645 1.645 0 005.5 5.891zM17.57 8.599c.359.155.793.247 1.268.247 1.213 0 2.195-.592 2.195-1.324 0-.731-.982-1.324-2.195-1.324-.455 0-.879.083-1.227.227a.796.796 0 00-.553-.227h-.32a.784.784 0 00-.775.702c-.984.103-1.711.458-1.711.884 0 .507 1.023.916 2.293.916a5.323 5.323 0 001.025-.101z" />
      <path d="M24.254 11.952V2.965a.488.488 0 00-.49-.488H.496A.492.492 0 000 2.965v20.139c0 .27.221.491.496.491h15.455a7.143 7.143 0 004.658 1.722 7.183 7.183 0 007.184-7.183 7.171 7.171 0 00-3.539-6.182zm-13.266-1.657C8.33 7.641 5.76 17.91 5.76 17.91H2.246V4.703h20.172v6.487a7.138 7.138 0 00-1.809-.24 7.177 7.177 0 00-6.678 4.557c-.558-1.639-1.497-3.762-2.943-5.212zm9.621 13.429a5.59 5.59 0 11.001-11.181 5.59 5.59 0 01-.001 11.181z" />
      <path d="M21.584 14.223L19.197 14.223 19.197 16.944 16.42 16.944 16.42 19.331 19.197 19.331 19.197 22.132 21.584 22.132 21.584 19.331 24.33 19.331 24.33 16.944 21.584 16.944z" />
    </svg>
  )
}
